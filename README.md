...
> A modern digital twin simulation for industrial press thermal control, featuring dynamic predictive pre-heating and PID-based feedforward compensation.
...
2. **`pid_controller.py`**
   ...
   - **Spike-Free Derivative**: Safely computes derivative terms on the initial step.
...
```mermaid
graph TD
    A[IDLE] --> B[PREHEAT <br> 100% Valve]
    B --> C[CURING <br> 180°C, ~38.75% Valve]
    C -- Gap ≤ 60 mins --> D[STANDBY <br> 150°C, ~10-31% Valve]
    C -- Gap > 60 mins <br> or End of Day --> E[COOLING <br> 0% Valve]
    D --> F[PREHEAT <br> Sensor-Triggered]
    E --> A
